...
export default function Sidebar({ collapsed, onToggle }) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onToggle}
        className="absolute top-12 -right-3 w-6 h-12 bg-[#1e2337] border border-[#2d3555] rounded-r-md flex items-center justify-center text-[#64748b] hover:text-white hover:bg-[#2d3555] transition-all duration-150 group"
