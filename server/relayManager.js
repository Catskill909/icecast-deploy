...
export function startRelay(stationId) {
    ...
    // CRITICAL: In fallback mode, stream to the FALLBACK mount so Icecast can switch
    // When encoder connects to main mount, Icecast uses fallback-override=1 to take over
